       ...
       <tr>
        ...
        <form method="post" action="ViewUserProfile.jsp">
          ...
          <td>
              ...
              <input type="text" name="placename" value="<%=p.getQuery()%>" readonly >
           </td>  
           ...
           <td>
             ...
             <form method="post" action="replayquery.jsp">
          
            
             <input type="hidden" name="feedbackid" value="<%=p.getQueryid()%>" >
              <input type="hidden" name="userid" value="<%=p.getUserid()%>" >
