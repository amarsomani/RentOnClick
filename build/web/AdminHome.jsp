...
<html>
    ...
    <head><title> Rent On Click</title>
...
<link href="bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet">
 ...
 <link href="fontawesome-free-5.0.7/web-fonts-with-css/css/fontawesome-all.min.css" 
       rel="stylesheet">        
 <link href="css/index_3.css" rel="stylesheet" type="text/css">
...
<header>
     ...
     String name1=(String)session.getAttribute("name");
       ...
       session.setAttribute("search1","5");
...
<!--            <button type="submit" class="btn btn-default" formaction="searchPlaces.jsp">
     </form>
...
<!--                 <a href="AdminLogin.jsp" class="btn btn-info" role="button">
 ...
 <a href="Admin_searchPlaces.jsp" class="btn btn-info" role="button">
            <button type="button" class="btn btn-default" onclick="Admin_searchPlaces.jsp">
      <span class="glyphicon glyphicon-search"></span> Search
            </button></a>
...
<a href="Admin_addPlace.jsp" class="btn btn-info" role="button">
      ...
      <span class="	glyphicon glyphicon-open"></span> Add Place
               ...
               <a href="Admin_viewPlace.jsp" class="btn btn-info" role="button">
            <button type="button" class="btn btn-default">
...
<section class="parallax">
  ...
  <a href="AdminHome.jsp"><i class="fas fa-home"></i>
      <p>Home</p>
  </a> 
  <a href="Admin_ViewAll.jsp"><i class="fas fa-eye"></i><p>View</p></a> 
  
  <a href="AdminHome.jsp"><i class="far fa-hand-point-left"></i><p>Back</p>  </a> 
       
  <a href="Admin_viewQuery.jsp"><i class="far fa-question-circle"></i>  <p>V_Query</p>     
</a> 
  <a href="Admin_viewFeedback.jsp"><i class="fas fa-edit"></i><p>V_Feedback</p></a> 
  
  <a href="Admin_showMyCart.jsp"><i class="fas fa-shopping-cart"></i>  <p>Cart</p></a> 

  <a href="Admin_ViewMyProfile.jsp"><i class="far fa-user"></i>   <p>Profile</p> </a>
