...
<header>
    ...
    <ul class="main-nav">
        ...
        <li><a href="showAddAvailable.jsp">AddAvailable</a><vertical_separator></vertical_separator></li>
        <li><a href="BookAllAvailablePlaces.jsp">BookPlaces</a><vertical_separator></vertical_separator></li>
        <li><a href="showMyAvailables.jsp">MyAvailable</a><vertical_separator></vertical_separator></li>
...
<!--       <li><a href="showMyCart.jsp">Cart</a><vertical_separator></vertical_separator></li>-->
        ...
        <li><a href="searchPlaces.jsp">SearchPlaces</a><vertical_separator></vertical_separator></li>
...
<!--        <li><a href="login.jsp" class ="btn btn-half">Login</a></li>-->
        ...
        <li><a href="sessionExpiore.jsp" class="btn btn-full">Logout</a><vertical_separator></vertical_separator></li>
...
<h1>Welcome To The First Ever <br>WEBSITE<br>With Which Becoming a Tenant Or a Squire<br>Is just like piece of cake </h1>
    ...
    <h3 class="text-center">FACILITIES WE'RE PROVIDING...</h3>
        ...
        <div class="container">
            ...
            <a href="searchPlaces.jsp" class="btn btn-info" role="button">
      ...
      <span class="glyphicon glyphicon-log-in"></span> Login
            ...
            <a href="sessionExpiore.jsp" class="btn btn-info" role="button">
            <button type="button" class="btn btn-default" onclick="login.jsp">
...
<!--            
      ...
      <span class="	glyphicon glyphicon-log-out"></span> Log out
        ...
        -->
        <a href="AddPlace.html" class="btn btn-info" role="button">
            <button type="button" class="btn btn-default">
      <span class="	glyphicon glyphicon-open"></span> Add Place
      
            </button></a>
                
               <a href="ViewAll.jsp" class="btn btn-info" role="button">
            <button type="button" class="btn btn-default">
