...
<%!
 String email,img;
List<Feedback> myList ;
  QueryDAO pd=new QueryDAO();
  String img1,img2;  
%>
<!DOCTYPE html>
<html>
...
<table bgcolor="pink" border="5">
       <tr>
        ...
        <form method="post" action="ViewUserProfile.jsp">
          ...
          <td>
              ...
              <input type="text" name="placename" value="<%=p.getFeedback()%>" readonly >
           </td>  
        
            <td>
              <input type="text" value="<%=p.getStar()%>"  readonly>
           </td>  
           ...
           <td>
               <input type="submit" value="UserDetails"  readonly>
             ...
             <form method="post" action="replayfeedback.jsp">
          
            
             <input type="hidden" name="feedbackid" value="<%= p.getFeedbackid()%>" >
              <input type="hidden" name="userid" value="<%=p.getUserid()%>" >
               <input type="submit" value=" Replay"  readonly>
           </td>  
  ...
  <a href="viewQueryAdmin.jsp"><i class="far fa-question-circle"></i>  <p>Query</p>     
</a> 
  <a href="viewFeedbackAdmin.jsp"><i class="fas fa-edit"></i><p>Feedback</p></a> 
